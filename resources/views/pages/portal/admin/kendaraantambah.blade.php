...
<head>
    <meta charset="utf-8">
    <title>Portal Rental - Kendaraan View</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ URL::to('/') }}/portal/admin/dashboard" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{ URL::to('/') }}/portal/admin/kendaraan/view" class="nav-item nav-link"><i class="fa fa-car me-2"></i>Kendaraan</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="h-100  rounded p-4">
                            ...
                            <a href="view"><button class="btn-danger" >Kembali</button></a><br><br>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="merk"required name="merk">
                                <label for="floatingInput">Merk Kendaraan</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="model"required name="model">
                                <label for="floatingPassword">Model Kendaraan</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="model" required name="plat">
                                <label for="floatingPassword">Plat Kendaraan</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword"
                                    placeholder="model"required name="denda">
                                <label for="floatingPassword">Nominal Denda</label>
                            </div>
