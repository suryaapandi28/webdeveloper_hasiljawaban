                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="h-100  rounded p-4">
                            ...
                            <a href="view"><button class="btn-primary" >Kembali</button></a><br><br>
                            <div class="card">
                            <table class="table " id="dataTables-example">
                                            ...
                                            <tbody>
                                            @foreach ($getdatakendaraan['data'] as $peminjam)

                                                <tr>
                                                    <td>{{ $peminjam['merk_kendaraan'] }}</td>
                                                    <td>{{ $peminjam['model_kendaraan'] }}</td>
                                                    <td>{{ $peminjam['plat_kendaraan'] }}</td>
                                                    <td>{{ $peminjam['nominal_denda'] }}</td>
                                                    <td>{{ $peminjam['status_kendaraan'] }}</td>
                                                    <td><a href="{{ URL::to('/') }}/portal/pengguna/peminjamaan/tambah/{{ $peminjam['code_kendaraan'] }}"><button class="btn-primary" >Minjam</button></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
