...
<head>
    <meta charset="utf-8">
    <title>Portal Rental - Sign In</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        @include('notifications')
                         <form novalidate action="login/validasi" method="post">
                        @csrf <br>
                        ...
                        <p class="text-center mb-0">Don't have an Account? <a href="{{ URL::to('/') }}/register">Register</a></p>
                    </div>
                </div>
                </form>
            </div>
